...
#if NUM_SERVICES > 1
// the header file with the public function prototypes
#define SERV_1_HEADER "EventPrinter.h"
// the name of the Init function
#define SERV_1_INIT InitEventPrinter
// the name of the run function
#define SERV_1_RUN RunEventPrinter
// How big should this services Queue be?
...
#if NUM_SERVICES > 2
// the header file with the public function prototypes
#define SERV_2_HEADER "PeriodicEventCheckerService.h"
// the name of the Init function
#define SERV_2_INIT InitPeriodicEventCheckerService
// the name of the run function
#define SERV_2_RUN RunPeriodicEventCheckerService
// How big should this services Queue be?
...
#if NUM_SERVICES > 3
// the header file with the public function prototypes
#define SERV_3_HEADER "MasterSM.h"
// the name of the Init function
...
#if NUM_SERVICES > 4
// the header file with the public function prototypes
#define SERV_4_HEADER "Project_MotorService.h"
// the name of the Init function
...
#if NUM_DIST_LISTS > 0 
#define DIST_LIST0 PostMasterSM, PostMapKeys
#endif
#if NUM_DIST_LISTS > 1 
#define DIST_LIST1 PostEventPrinter, PostMasterSM
#endif
#if NUM_DIST_LISTS > 2 
#define DIST_LIST2 PostEventPrinter, PostPeriodicEventCheckerService
#endif
#if NUM_DIST_LISTS > 3 
...
#define TIMER2_RESP_FUNC ES_PostList02
#define TIMER3_RESP_FUNC ES_PostList01
#define TIMER4_RESP_FUNC PostMotorService
#define TIMER5_RESP_FUNC ES_PostList01
#define TIMER6_RESP_FUNC ES_PostList01
#define TIMER7_RESP_FUNC ES_PostList01
...
#define GAME_TIMER 0
#define PAC_TIMER 1
#define PERIODIC_EVENT_CHECKER_TIMER 2
#define TURN_TIMER 3
#define RPMTimer 4
#define LEAVING_CITY_TIMER 5
#define IDLE_TIMER 6
#define REQUEST_WAIT_TIMER 7
